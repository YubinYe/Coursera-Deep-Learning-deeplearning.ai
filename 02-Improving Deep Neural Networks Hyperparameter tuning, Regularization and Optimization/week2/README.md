...
$$S^{corrected}_{dW} = \frac{S_dW}{1-{\beta_2}^t}$$

$$S^{corrected}_{db} = \frac{S_db}{1-{\beta_2}^t}$$

- 所以，更新 $W$、$b$ 时有：

$$W := W - \alpha \frac{V_corrected_dW}{\sqrt{S_corrected_dW} + \epsilon}$$

$$b := b - \alpha \frac{V_corrected_db}{\sqrt{S^corrected_db} + \epsilon}$$
